...
async function forceCreate() {
    try {
        console.log('🛠️  Force Creating Table api_access_requests...');
        ...
        // Setup index (bonus)
        try {
            await db.execute("CREATE INDEX `idx_api_requests_email` ON `api_access_requests` (`contact_email`)");
            console.log('✅ Index Created.');
        } catch (e) {
            console.log('⚠️ Index might exist:', e.message);
        }
