...
export const QuoteCard = ({ quote, className = "", ...props }) => (
  <Card
    className={`w-full max-sm:hidden bg-white shadow-sm transition-all duration-300 border-none hover:ring-primary hover:ring-1 sm:hover:ring-2 overflow-hidden relative rounded-2xl !p-0 ${className}`}
    {...props}
  >
